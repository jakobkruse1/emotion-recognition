...
class TextEmotionClassifier(EmotionClassifier):
    """
    Base class for all text emotion classifiers. Contains common functionality
    that concerns all text classifiers.
    """

    def __init__(self, name: str = "text", parameters: Dict = None):
        """
        ...
        """
        super().__init__(name, "text", parameters)
