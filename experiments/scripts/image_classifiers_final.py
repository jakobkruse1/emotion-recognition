"""This script runs the best image classifier configurations with balancing
and augmentation and checks the impact of these changes."""
import sys
...
if __name__ == "__main__":
    ...
    runner = ExperimentRunner("image_balance_parameters")
